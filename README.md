...
Пользователь может записаться в отделение к определенному времени. Он получает уникальный код, который может ввести на терминале уже в офисе и попасть в приоритетную очередь.
Возможная нагрузка на офис становится более предсказуемой. А у сотрудников отделения есть возможность подготовить необходимые документы заранее.
