...
Работает с учетом загруженности и скорости оказания конкретной услуги, если она указана. 
~~~
score = 0
...
Извлекаем эмбеддинг входящего запроса с помощью предобученной модели. Считаем попарную близость (косинусное расстояние) с предпосчитанными эмбеддингами услуг и различных синонимов. Выбираем услугу, к которой входящий запрос наиболее близок по смыслу
